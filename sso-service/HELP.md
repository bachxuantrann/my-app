...
* The original package name 'bachtx.myapp.sso-service' is invalid and this project uses 'bachtx.myapp.sso_service' instead.
...
* [OAuth2 Authorization Server](https://docs.spring.io/spring-boot/3.5.13/reference/web/spring-security.html#web.security.oauth2.authorization-server)
